export const translations = {
    'en': {
        ...
        'about': 'About me',
        'portfolioTitle': 'Paweł Janusz portfolio',
        'name': 'John Doe',
        'position1': 'C# Developer',
        'position2': 'Unity VR Developer',
        'darkMode': 'Dark Mode',
        'projects': 'Projects',
        'hobby-projects': 'Hobby Projects',
        'about-me': 'About me',
        'contact': 'Contact',
        'about-me-content': 'As a VR game programmer, I connected my dreams with reality. My experience in Unity, which I expanded by participating in numerous game jams, including 1st place at HackYeah 2021 or Copernicus in Warsaw in 2022, has resulted in many creative projects. While working on a sailing game in MarineVerse, I immersed myself in its world, which was an unexpected but exciting discovery for me. Last year I completed a sailing course and obtained a license, which enriched my life with a new hobby. Now that I have some wind in my hair, I am looking for further inspirations and challenges, I want to create projects that will be equally interesting.',
    ...
    'pl': {
        ...
        'name': 'Jan Kowalski',
        'position1': 'Programista C#',
        'position2': 'Unity VR Deweloper',
